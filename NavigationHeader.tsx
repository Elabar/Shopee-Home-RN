      ...
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        <Animated.View style={searchBoxStyle}>
          ...
          <View style={{ flex: 1, paddingHorizontal: padding }}>
            <TextInput placeholder="Eucerin: RM90 Off Voucher + Free Shipping + GUGUBIRD" />
          </View>
        ...
        <View style={{ paddingHorizontal: padding }}>
          <IconWithBadge iconName="cart-outline" badgeLabel="6" scrollPosY={scrollPosY} />
        </View>
        <View style={{ paddingHorizontal: padding }}>
          <IconWithBadge iconName="chatbubbles-outline" badgeLabel="6" scrollPosY={scrollPosY} />
        </View>
      </View>
    </Animated.View>
  );
